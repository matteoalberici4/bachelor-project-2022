...
class Subckt(Entity):
    """
    A sub-circuit object with an input, an output, and an operator.
    """
    ...
    def children(self):
        """
        Get the sub-circuit children.

        :return: returns the sub-circuit children
        """
    ...
    def parents(self):
        """
        Get the sub-circuit parents.

        :return: returns the sub-circuit parents
        """
